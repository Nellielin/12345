          ...
          <main id="main" class="content-main overflow-auto flex-shrink-1 h-100">
            ...
            <div class="overflow-hidden">
              ...
              <div class="row d-flex justify-content-between btn-group align-items-center">
                <form action="ST-discount-search.php" method="get" class="col-6 ">
                  <div class="col-4 d-flex keywordBar ms-4">
                    <input type="text" class="form-control col-8 mt-2 me-3" name="keyword" placeholder="輸入關鍵字">
                ...
                <!-- 下拉式排序start -->
                <div class="col-2 dropdown-left d-flex me-5   justify-content-end align-item-flex-end  mt-3">
              ...
              <div class="row d-flex mt-3 justify-content-between">
                ...
                <!-- end 全部有效失效 -->
                <!-- 新增優惠券 -->
                <div class="col-4 d-flex justify-content-end mt-2 me-5 ">
                  <button class="btn yellowBtn justify-content-end" onclick="window.location.href='ST-discount-create.php'">新增優惠券 </button>
                </div>
                <!-- end新增優惠券 -->
                ...
                <table class="table table-sm table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="align-middle text-center">此優惠的商品</td>
